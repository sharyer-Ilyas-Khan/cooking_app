...
class ContDishes extends StatefulWidget {
  const ContDishes({Key key}) : super(key: key);

  @override
  _ContDishesState createState() => _ContDishesState();
}

class _ContDishesState extends State<ContDishes> {
  @override
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                ...
                // ColorFilter.mode(Colors.black.withOpacity(0.2),BlendMode.colorBurn),
                  image: AssetImage("images/itnoodels.jpg"),fit: BoxFit.fill
              ),
            ),
          ),
        ),
        Expanded(
          child: Container(
            ...
            child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              stream: FirebaseFirestore.instance.collection('continental').snapshots(),
              builder: (_, snapshot) {
                      ...
                      return InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (_)=>
                                RecipeDetails(Recipe: snap.id,image: image,Direct:dec.toString(),listOfingre:ing)));
                          },
