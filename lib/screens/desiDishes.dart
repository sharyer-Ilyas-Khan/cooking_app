...
class DesiDishes extends StatefulWidget {
  const DesiDishes({Key key}) : super(key: key);

  @override
  _DesiDishesState createState() => _DesiDishesState();
}

class _DesiDishesState extends State<DesiDishes> {
  @override
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                ...
                // ColorFilter.mode(Colors.black.withOpacity(0.2),BlendMode.colorBurn),
                  image: AssetImage("images/karahi.jpg"),fit: BoxFit.fill
              ),
            ),
          ),
        ),
        Expanded(
          child: Container(
            ...
            child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              stream: FirebaseFirestore.instance.collection('desi').snapshots(),
              builder: (_, snapshot) {
