...
class ItalianDishes extends StatefulWidget {
  const ItalianDishes({Key key}) : super(key: key);

  @override
  _ItalianDishesState createState() => _ItalianDishesState();
}
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                ...
                // ColorFilter.mode(Colors.black.withOpacity(0.2),BlendMode.colorBurn),
                  image: AssetImage("images/slad.jpg"),fit: BoxFit.fill
              ),
            ),
          ),
        ),
        Expanded(
          child: Container(
            ...
            child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              stream: FirebaseFirestore.instance.collection('italian').snapshots(),
              builder: (_, snapshot) {
